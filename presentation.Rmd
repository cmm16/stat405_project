...
- Ex: Dropped reviews that did not have rating score
...
ggplot() + 
  ...
  ylab("Count") + 
  labs(fill = "Airports") +
  ggtitle("Distribution of Ratings for Top 10 Airports in 2018") +
...
Result  <- c(rep("Failure",5), rep("Success",3), rep("Failure",9), rep("Success",40),
            rep("Success",3), rep("Failure",1), rep("Success",2), rep("Failure",28), rep("Success",69),
            rep("Failure",2), rep("Success",2))
...
dyplot.prophet(m, forecast, ylab="test")
```
...
Type         MAE          MAPE  
-------     -------      ----------  
     1      17.53556     0.04550617     
     2      19.77747     0.04323118
